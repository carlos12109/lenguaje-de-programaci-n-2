...
# === CLASE BIBLIOTECA CON EXPORTACIÓN AUTOMÁTICA ===
class Biblioteca:
    def __init__(self):
        self.__libros = []
        self.__reservas = []
    ...
    def registrar_libro(self, titulo, autor, codigo):
        ...
        self.exportar_datos()  # ← Exporta automáticamente
    ...
    # === NUEVO MÉTODO QUE LLAMA A TXT Y CSV ===
    ...
    def exportar_txt(self, nombre_archivo="libros.txt"):
        ...
        print(f"Datos exportados automáticamente a {nombre_archivo}")
...
# === MENÚ SIN OPCIONES DE EXPORTACIÓN ===
def menu():
